...
from .aquatic_plants_detector_provider import AquaticPlantsDetectorProvider
...
class AquaticPlantsDetectorPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = AquaticPlantsDetectorProvider()
